...
namespace Common
{
    // =========================================================================================================================
    /// <summary>
    /// This class contains global (shared) utility methods used by most Silverlight-base applications.
    /// </summary>
    public partial class Utilities
    {
        ...
        /// <returns></returns>
        public static T LoadXAML<T>(Uri fileUri, string parseBeginText = null, string parseEndText = null) where T : class
        {
        ...
        public static T LoadXAML<T>(string filename, string path = "", string assemblyName = "",
            string parseBeginText = null, string parseEndText = null) where T : class
        {
    ...
    public static partial class ExtentionMethods
    {
        ...
        public static Binding SetSimpleBinding(this DependencyObject source, FrameworkElement targetElement, DependencyProperty dpOnTargetElement, string sourcePropertyName, BindingMode bindingMode = BindingMode.OneWay, Action<Binding> setOtherBindingPropertiesCallback = null)
        {
        ...
        public static Point TransformPoint(this FrameworkElement element, Point pointToTransform, FrameworkElement relativeToThisParent = null)
        {
    ...
    {
        /// <summary>
        /// Returns the Silver Window desktop-based visual root.
        /// <para>Warning: It is advised to use this instead of 'Application.Current.RootVisual'.
        /// Silver Windows may nest elements from the root before the desktop root begins.</para>
        /// </summary>
        public static FrameworkElement RootVisual
        { get { return Application.Current != null ? Application.Current.RootVisual as FrameworkElement : null; } }
        ...
        /// <param name="rootVisual">The object acting as the root visual, or 'null' for 'Application.Current.RootVisual'.</param>
        public static FrameworkElement ParentPanelRootChild(FrameworkElement searchStart, DependencyObject rootVisual = null)
        {
            if (rootVisual == null) rootVisual = Application.Current.RootVisual;
        ...
        public static FrameworkElement GetElement(string name, Func<FrameworkElement, IEnumerable<FrameworkElement>> bridgeHandler = null, bool ignoreNameScopes = false)
        {
        ...
        /// Each element in the name scope is given to the handler if there is no match, along with the identifier name to look for, and if a non-null value is returned, the search ends.</param>
        /// <param name="ignoreNameScopes">If name scopes are not ignored, the template children are also considered.</param>
        public static EType GetElement<EType>(this FrameworkElement rootElement, Func<FrameworkElement, IEnumerable<FrameworkElement>> bridgeHandler = null, bool ignoreNameScopes = false)
        ...
        /// Each element in the name scope is given to the handler if there is no match, along with the identifier name to look for, and if a non-null value is returned, the search ends.</param>
        /// <param name="ignoreNameScopes">If name scopes are not ignored, the template children are also considered.</param>
        public static FrameworkElement GetElement(this FrameworkElement rootElement, string name, Func<FrameworkElement, IEnumerable<FrameworkElement>> bridgeHandler = null, bool ignoreNameScopes = false)
        {
            if (rootElement == null) return null;
            return _GetElementByName(name, rootElement, bridgeHandler, ignoreNameScopes);
        }

        static FrameworkElement _GetElementByName(string name, FrameworkElement element, Func<FrameworkElement, IEnumerable<FrameworkElement>> bridgeHandler = null, bool ignoreNameScopes = false)
        {
            if (name == null) return null;
        ...
        /// <param name="returnLastObject">If 'true', instead of returning 'null' on exit, the last object checked of the requested type is returned. 'null' is still returned if there are no parent objects of the requested type.</param>
        ...
        public static T GetParentObject<T>(DependencyObject searchStart, bool includeDerivedTypes = false, bool returnLastObject = false,
            Func<FrameworkElement, bool> whileFilter = null,
            Func<T, bool> whereFilter = null) where T : DependencyObject
        {
        ...
        public static bool IsMouseOver(UIElement element, Point point, UIElement subTree = null)
        {
            if (subTree == null) subTree = Application.Current.RootVisual;
    ...
    public partial class Dispatching
    {
        ...
        {
            if (Application.Current.RootVisual != null)
                Application.Current.RootVisual.Dispatcher.BeginInvoke(d, args);
            else
        ...
        /// </summary>
        public static void QueueDispatch(int priority, Action a, string keyScope = null, object key = null)
        {
        ...
        /// Queues an action under optional scope and key categories to be executed in consecutive sequence (synchronized).
        /// </summary>
        public static void QueueDispatch(Priority priority, Action a, string keyScope = null, object key = null)
        ...
        /// </summary>
        public static void CancelQueuedDispatch(string keyScope, object key = null)
        {
        ...
        /// To force dispatch queuing, use one of the 'Dispatch()' methods instead.
        /// </summary>
        ...
        public static void ElementPreLoadDispatch(FrameworkElement element, int priority, Action a, string keyScope = null, object key = null)
        { ElementPreLoadDispatch(element, priority, keyScope, key, a, null); }
        public static void ElementPreLoadDispatch(FrameworkElement element, Priority priority, Action a, string keyScope = null, object key = null)
