...
namespace Common.Silverlight.Scripting
{
    /// <summary>
    ...
    /// Each code block, in the order added, is dispatched using the Silverlight "Dispatch" queue system.
    ...
    public partial class CodeBlockQueueScript
    {
        ...
        void _DoNextAsync() { _Dispatcher.Dispatcher.BeginInvoke(_DoNext); }
