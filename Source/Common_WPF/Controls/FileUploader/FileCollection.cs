...
namespace Vci.Silverlight.FileUploader
{
    ...
    public class FileCollection : ObservableCollection<UserFile>
    {
        ...
        /// <summary>
        /// Total number of files ready to be uploaded.
        /// </summary>
        [ScriptableMember()]
        public int TotalFilesReadyForUpload //<<
        {
            get
            {
                return (from f in this.Items
                        where f.State == Constants.FileStates.Ready || f.State == Constants.FileStates.Pending
                        select f).Count();
            }
        }
        ...
        private void FileCollection_CollectionChanged(object sender, System.Collections.Specialized.NotifyCollectionChangedEventArgs e)
        {
            ...
            RecountTotal();
            this.OnPropertyChanged(new PropertyChangedEventArgs("TotalFilesSelected")); //<<
            this.OnPropertyChanged(new PropertyChangedEventArgs("TotalFilesReadyForUpload")); //<<
        }
        ...
        private void item_PropertyChanged(object sender, PropertyChangedEventArgs e)
        {
            ...
            else if (e.PropertyName == "State")
            {
                ...
                else if (file.State == Constants.FileStates.Processing)
                {
                    ...
                    UploadFiles(); // get next upload batch ready
        ...
        private void OnSingleFileUploadFinished(FileUploadedEventArgs e)
        {
            if (SingleFileUploadFinished != null)
                SingleFileUploadFinished(this, e);
