...
namespace Common.WPF
{
    public static class U
    {
        ...
        /// The parent hierarchy is simply searched for the first occurrence of the string combination and desired element type.
        /// <para>
        ...
        /// Warning: Globally unique IDs (which start with '#') should never be used in templates, or reusable controls, but in the application scope only.
        /// </para>
        /// </summary>
